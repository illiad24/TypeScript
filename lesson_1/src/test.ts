...
// if(userName)
//     document.write(`Привіт! У твоємо імені ${userName.length} букв`)
// else
//     document.write('Bye!')

// 2. Випадковим чином генерується 10 разів число або якийсь рядок. Пірахувати чого було більше чисел чи рядків і вивести останне число чи останній рядок
// let stringCount = 0
// let numberCount = 0
